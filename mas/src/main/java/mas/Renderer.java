 ...
 * 
 */
public class Renderer implements ModelRenderer {

  enum Language {
    DUTCH("laden", "uitladen"), ENGLISH("loading", "unloading");
  ...
  public void renderDynamic(GC gc, ViewPort vp, long time) {
    final Set<GreedyVehicle> taxis = rm.get().getObjectsOfType(GreedyVehicle.class);
    synchronized (taxis) {
      for (final GreedyVehicle t : taxis) {
